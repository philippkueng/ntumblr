...
fs      = require('fs')
photo   = fs.readFileSync('photo.jpg').toString('binary').replace(/\s/gi, '+')
#console.log photo
#console.log photo.toString('hex')
iconv   = new Iconv('utf8', 'ISO-8859-1')
photo= iconv.convert(photo).toString()
...
console.log fs.readFileSync('photo.jpg').toString('base64')
